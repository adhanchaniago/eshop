...
class Transaksi extends CI_Controller {
   ...
   public function index()
   {
      ...
      $select = ['id_order', 'tgl_pesan', 'bts_bayar', 'nama_user', 'o.status AS status'];
   ...
   public function detail()
   {
      ...
      $select = ['o.id_order AS id_order', 'tgl_pesan', 'bts_bayar', 'nama_user', 'o.status AS status', 'pos', 'service', 'kota', 'tujuan', 'total', 'biaya', 'kurir', 'nama_item', 'qty'];
